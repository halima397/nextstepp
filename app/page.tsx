  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <footer className="flex justify-center py-4 bg-gray-800 text-white dark:bg-gray-900">
        <p className="text-sm">
          Powered by <Link href="https://nextjs.org" className="text-blue-400">Next.js</Link> and <Link href="https://tailwindcss.com" className="text-blue-400">Tailwind CSS</Link>.
        </p>
      </footer>
    </div>
  );
